...
class ContentfulPagingFeature extends ContentfulBaseFeature
{
    ...
    private function _graphql_pre_request(ContentfulContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(ContentfulContext $ctx): bool
    {
