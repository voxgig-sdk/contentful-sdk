...
// Contentful SDK timeout feature
...
class ContentfulTimeoutFeature extends ContentfulBaseFeature
{
    ...
    private function _with_timeout(ContentfulContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ContentfulContext $_ctx, float $ms): void
    {
        $client = $this->client;
