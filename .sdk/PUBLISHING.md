...
|---|---|---|
| `js/` | @voxgig-sdk/contentful-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/contentful | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/contentful-js \
      --repository voxgig-sdk/contentful-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/contentful-js` shows it, and
`npm trust revoke @voxgig-sdk/contentful-js --id=<id>` removes it.
