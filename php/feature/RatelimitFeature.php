...
// Contentful SDK ratelimit feature
...
class ContentfulRatelimitFeature extends ContentfulBaseFeature
{
    ...
    private function _acquire(ContentfulContext $ctx): void
    {
    ...
    private function _track(ContentfulContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
