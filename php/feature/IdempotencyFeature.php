...
// Contentful SDK idempotency feature
...
class ContentfulIdempotencyFeature extends ContentfulBaseFeature
{
    ...
    private function _mutating(ContentfulContext $ctx): bool
    {
