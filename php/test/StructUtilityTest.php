...
// Contentful SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ContentfulOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ContentfulOmni::structfix($now, Struct::undef()))
                        !== json_encode(ContentfulOmni::structfix($val, Struct::undef()))) {
